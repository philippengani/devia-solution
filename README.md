...
This diagram shows the full request lifecycle, including FastAPI, orchestrator selection, local tools, Langfuse, and the OpenAI-compatible provider path.
...
You can also fetch the Mermaid graph directly from the app at `GET /architecture/diagram`, or view the standalone copy in [docs/runtime-architecture.md](docs/runtime-architecture.md).
